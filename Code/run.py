...
# 選擇 Groq 作為 AI 分類主力（速度極快且免編譯）
AI_API_URL = "https://api.groq.com/openai/v1/chat/completions"
AI_API_KEY = "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"
AI_MODEL = "llama-3.3-70b-versatile" # Groq 目前最強且穩定的開源模型

# GitHub 專用 Token (使用你提供的其中一組)
...
# --- 2B. 抓取 Hugging Face 模型 (帶入 Token) ---
