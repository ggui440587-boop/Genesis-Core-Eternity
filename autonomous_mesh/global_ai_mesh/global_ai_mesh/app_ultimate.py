...
def api_status():
    total_records = 0
    sections = {"流量變現": [], "情報同步": [], "內容變現": [], "系統運作": []}
    counts = {"流量變現": 0, "情報同步": 0, "內容變現": 0, "系統運作": 0}
...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .header-panel { background: #161b22; border: 1px solid #30363d; padding: 10px 12px; border-radius: 6px; margin-bottom: 8px; }
        ...
        .card { background: #161b22; border: 1px solid #30363d; padding: 8px 10px; border-radius: 6px; margin-bottom: 8px; }
        .card-title { font-size: 0.75rem; color: #8b949e; margin-bottom: 5px; font-weight: bold; border-bottom: 1px solid #21262d; padding-bottom: 3px; display: flex; justify-content: space-between; align-items: center; }
        .badge { background: #21262d; color: #f0883e; padding: 1px 5px; border-radius: 4px; font-size: 0.68rem; border: 1px solid #30363d; }
        .item { font-size: 0.73rem; color: #7ee787; padding: 3px 0; border-bottom: 1px dashed #21262d; }
...
<body>
    <div class="header-panel">
        ...
        <div class="header-bottom">
            <span>多執行緒串流：<span class="status-ok">運行中 ( ACTIVE )</span></span>
            <span>更新頻率：2秒</span>
        </div>
    </div>
