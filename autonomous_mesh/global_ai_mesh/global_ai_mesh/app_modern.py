...
def background_worker():
    while True:
        try:
            ...
            try:
                ...
                with urllib.request.urlopen(req, timeout=3) as resp:
                    ...
                    if items:
                        ...
                        gh_title = f"{repo['name']} (⭐{repo['stargazers_count']})"
            except:
                pass
            ...
            cursor.execute("INSERT INTO monetization_stream (platform, status) VALUES (?, ?)", (pf, f"SUCCESS_{random.randint(1000,9999)}"))
...
<body>
    ...
    <div class="stats-card">
        <span>資料庫累積紀錄總量 (DB Records)</span>
