...
<head>
    ...
    <style>
        ...
        .badge { background: #21262d; color: #f0883e; padding: 1px 6px; border-radius: 4px; font-size: 0.7rem; }
        .item { font-size: 0.75rem; color: #7ee787; padding: 3px 0; }
        .pulse { display: inline-block; width: 6px; height: 6px; background: #3fb950; border-radius: 50%; margin-right: 4px; box-shadow: 0 0 4px #3fb950; }
    </style>
</head>
<body>
    <div class="box">
        <span><span class="pulse"></span>總紀錄累積：<b id="total" style="color: #f0883e;">0</b></span>
